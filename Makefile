...
extout = 
extout_prefix = 
target_prefix = /similarity_sorting
LOCAL_LIBS = 
...
pre-install-rb-default: $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.time
install-rb-default: $(RUBYLIBDIR)/similarity_sorting.rb
$(RUBYLIBDIR)/similarity_sorting.rb: $(srcdir)/lib/similarity_sorting.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/similarity_sorting.rb $(@D)
pre-install-rb-default: $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.-.similarity_sorting.time
install-rb-default: $(RUBYLIBDIR)/similarity_sorting/version.rb
$(RUBYLIBDIR)/similarity_sorting/version.rb: $(srcdir)/lib/similarity_sorting/version.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.-.similarity_sorting.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/similarity_sorting/version.rb $(@D)
pre-install-rb-default:
	$(ECHO) installing default  libraries
$(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.time:
	$(Q) $(MAKEDIRS) $(@D) $(RUBYLIBDIR)
	$(Q) $(TOUCH) $@
$(TIMESTAMP_DIR)/.RUBYLIBDIR.-.similarity_sorting.-.similarity_sorting.time:
	$(Q) $(MAKEDIRS) $(@D) $(RUBYLIBDIR)/similarity_sorting
	$(Q) $(TOUCH) $@
